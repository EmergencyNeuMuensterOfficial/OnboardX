...
const COLLECTIONS = {
  ...
  inviteStats: 'invite_stats',
  inviteJoins: 'invite_joins',
...
async function ensureIndexes() {
  ...
  await Promise.all([
    ...
    getCollection(COLLECTIONS.moderationCases).createIndex({ guildId: 1, caseId: -1 }, { unique: true }),
    getCollection(COLLECTIONS.moderationCases).createIndex({ guildId: 1, targetId: 1, createdAt: -1 }),
    getCollection(COLLECTIONS.inviteStats).createIndex({ guildId: 1, inviterId: 1 }, { unique: true }),
    getCollection(COLLECTIONS.inviteJoins).createIndex({ guildId: 1, userId: 1 }, { unique: true }),
